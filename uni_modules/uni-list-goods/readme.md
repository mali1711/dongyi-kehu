...
这是基于 [uni-list](https://ext.dcloud.net.cn/plugin?id=24) 扩展的云端一体的商品列表页面模版。
...
- 基于 [uni-clientDB](https://ext.dcloud.net.cn/plugin?id=2314) 操作数据库，查看[文档](https://uniapp.dcloud.io/uniCloud/uni-clientDB)
- 支持下拉刷新、上拉加载
- 支持列表、宫格视图互相切换
