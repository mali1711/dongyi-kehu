...
/***/ 19:
/*!***********************************************************!*\
  !*** /Users/mali/Ob/uni-app/董亿客户端1/董亿客户端/common/utils.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
var dateUtils = {
  ...
  compare: function compare(dateStr) {
  ...
  _format: function _format(number) {
    return number < 10 ? '0' + number : number;
  },
  crtDate: function crtDate() {//获取当前日期yyyy-mm-dd
    var date = new Date();
    return date.getFullYear() + '-' + this._format(date.getMonth() + 1) + '-' + this._format(date.getDate());
  },
  crtTime: function crtTime() {//获取当前时间hh-mm
    var date = new Date();
    return this._format(date.getHours()) + ':' + this._format(date.getMinutes());
  },
  myFormat: function myFormat(dateStr) {
    var date = this.parse(dateStr);
    return date.getFullYear() + '/' + this._format(date.getMonth() + 1) + '/' + this._format(date.getDate()) + ' ' +
    this._format(date.getHours()) + ':' + this._format(date.getMinutes());
  },
  someDayBefore: function someDayBefore(x) {//获取x天前的日期yyyy-mm-dd
    if (!x || !parseInt(x)) {
      return '';
    }
  ...
  getTimeStamp: function getTimeStamp(x) {//获取x天前的时间戳，x为空表示获取现在的时间戳
    var timeStamp = new Date().getTime();
    if (!x || !parseInt(x)) {
      return timeStamp;
    } else {
